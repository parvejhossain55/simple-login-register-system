...
if (isset($_POST['register'])) {
   $std = $student->studentRegister($_POST);
}
            ...
            <div class="p-5">
              ...
              <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" class="user">
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" placeholder="Enter Your Name" name="name">
                </div>
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" placeholder="Enter Your Email Address" name="email">
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user"  placeholder="Enter Repeat Password" name="repassword">
                  </div>
                </div>
